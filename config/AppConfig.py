...
search[
    'Streamlit Sidebar and Text Elements -                    Session-2 Streamlit side bar st.sidebar() Text input st.text() display input st.header() header st.write() write Sub Header SubHeader st.subheader() caption st.caption() st.markdown() Mark Down HTML Latex st.latex() Code st.code() session2'] = 'Streamlit Sidebar and Text Elements'
...
topics['Streamlit Sidebar and Text Elements'] = [2, 'Session-2', 'Streamlit Sidebar and Text Elements', '04-02-2022', Session2SidebarDisplayTextWidgets]
